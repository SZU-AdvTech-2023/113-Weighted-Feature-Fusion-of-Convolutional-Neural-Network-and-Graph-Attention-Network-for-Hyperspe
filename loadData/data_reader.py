...
class PaviaURaw(DataReader):
    def __init__(self):
        ...
        raw_data_package = sio.loadmat(
            r"/home1/ywl/PycharmProject/Data_of_HIS_LIDAR/data/classification/Pavia University/PaviaU.mat")
        self.data_cube = raw_data_package["paviaU"].astype(np.float32)
        truth = sio.loadmat(
            r"/home1/ywl/PycharmProject/Data_of_HIS_LIDAR/data/classification/Pavia University/PaviaU_gt.mat")
        self.g_truth = truth["paviaU_gt"].astype(np.float32)


class Hong_HU_Raw(DataReader):
    def __init__(self):
        super(Hong_HU_Raw, self).__init__()
        raw_data_package = sio.loadmat(
            r"/home1/ywl/PycharmProject/Data_of_HIS_LIDAR/data/classification/Matlab_data_format/Matlab_data_format/WHU-Hi-HongHu/WHU_Hi_HongHu.mat")
        self.data_cube = raw_data_package["WHU_Hi_HongHu"].astype(np.float32)
        truth = sio.loadmat(
            r"/home1/ywl/PycharmProject/Data_of_HIS_LIDAR/data/classification/Matlab_data_format/Matlab_data_format/WHU-Hi-HongHu/WHU_Hi_HongHu_gt.mat")
        self.g_truth = truth["WHU_Hi_HongHu_gt"].astype(np.float32)


class yaolin(DataReader):
    def __init__(self):
        super(yaolin, self).__init__()
        raw_data_package = h5py.File(
            r"/home1/ywl/PycharmProject/Data_of_HIS_LIDAR/SZU_DATA/yaolin_data/ywl/mat-1/hsi-1.mat")
        self.data_cube = raw_data_package["data"].astype(np.float32)
        self.data_cube = np.transpose(self.data_cube, axes=(1, 2, 0))
        truth = h5py.File(
            r"/home1/ywl/PycharmProject/Data_of_HIS_LIDAR/SZU_DATA/yaolin_data/ywl/mat-1/ndvi_label-1.mat")
        self.g_truth = truth["ndvi_label"].astype(np.float32)
        self.g_truth = np.array(self.g_truth)


class jiaqi_yue(DataReader):
    def __init__(self):
        super(jiaqi_yue, self).__init__()
        raw_data_package = h5py.File(
            r"/home1/ywl/PycharmProject/Data_of_HIS_LIDAR/SZU_DATA/jiaqi_data/Yue-2_11.mat")
        self.data_cube = raw_data_package["data"]#.astype(np.float32)
        self.data_cube = np.transpose(self.data_cube, axes=(1, 2, 0))
        self.g_truth = raw_data_package["map"]#.astype(np.float32)
        self.g_truth = np.array(self.g_truth)
...
class IndianRaw(DataReader):
    def __init__(self):
        ...
        raw_data_package = sio.loadmat(r"/home3/ywl/PycharmProject/WFCG/Datasets/Indian_pines_corrected.mat")
        self.data_cube = raw_data_package["data"].astype(np.float32)
        truth = sio.loadmat(r"/home3/ywl/PycharmProject/WFCG/Datasets/Indian_pines_gt.mat")
